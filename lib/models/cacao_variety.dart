...
class CacaoVariety {
  ...
  /// Whether this clone has been approved by NSIC.
  bool get isApproved => nsicStatus == 'Approved';

  /// Human-readable Average Pod Index rating derived from the numeric value.
  String get podIndexRating {
    if (averagePodIndex == 0) return 'N.A.';
    if (averagePodIndex < 15) return 'Good (< 15)';
    if (averagePodIndex < 25) return 'Moderate (15–25)';
    return 'High (> 25)';
  }
}
...
const List<CacaoVariety> cacaoVarieties = [
  CacaoVariety(
    ...
    name: 'BR 25',
    owner: 'University of the Philippines - Los Baños (UPLB)',
    description:
